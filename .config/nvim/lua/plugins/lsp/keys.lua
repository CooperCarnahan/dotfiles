...
function M.setup(client, buffer)
  ...
  local keymap = {
    ...
    ["<leader>"] = {
      ...
      x = {
        d = { "<cmd>Telescope diagnostics<cr>", "Search Diagnostics", cond = not require("trouble") },
    ...
    g = {
      ...
      r = { "<cmd>Telescope lsp_references<cr>", "References", cond = not require("trouble") },
      R = { "<cmd>Telescope lsp_references<cr>", "[Telescope] LSP References" },
      D = { "<cmd>Telescope lsp_declarations<CR>", "Goto Declaration" },
      I = { "<cmd>Telescope lsp_implementations<CR>", "Goto Implementation" },
      t = { "<cmd>Telescope lsp_type_definitions<cr>", "Goto Type Definition" },
      h = { "<cmd>ClangdSwitchSourceHeader<cr>", "Toggle Header vs Source" },
    },
