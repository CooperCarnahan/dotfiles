...
hl.bind("CTRL + SPACE",         hl.dsp.exec_cmd(programs.applauncher),
...
hl.bind(mod .. " + Q",          hl.dsp.window.close(),
    { description = "Closes (not kills) the current window" })
...
hl.bind(mod .. " + Y",          hl.dsp.window.pin(),
    { description = "Pins the current window (shows on all workspaces)" })

-- ──────────────────────────────────────────────────────────────────────────
-- Screenshots
-- ──────────────────────────────────────────────────────────────────────────
hl.bind("Print",                       hl.dsp.exec_cmd(programs.shot_region),
    { description = "Creates a screenshot of an area" })
hl.bind("SUPER + SHIFT + S",           hl.dsp.exec_cmd(programs.shot_region),
    { description = "Creates a screenshot of an area" })
hl.bind("CTRL + Print",                hl.dsp.exec_cmd(programs.shot_window),
    { description = "Creates a screenshot of the active window" })
hl.bind("ALT + Print",                 hl.dsp.exec_cmd(programs.shot_screen),
...
-- Gaps toggle
-- ──────────────────────────────────────────────────────────────────────────
hl.bind(mod .. " + SHIFT + G",  hl.dsp.exec_cmd([[hyprctl --batch "keyword general:gaps_out 5;keyword general:gaps_in 3"]]),
    { description = "Set CachyOS default gaps" })
hl.bind(mod .. " + G",          hl.dsp.exec_cmd([[hyprctl --batch "keyword general:gaps_out 0;keyword general:gaps_in 0"]]),
...
hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("brightnessctl s 5%-"),
    { locked = true, repeating = true })
hl.bind(mod .. " + CTRL + L",    hl.dsp.exec_cmd(os.getenv("HOME") .. "/.config/hypr/scripts/lock"),
    { description = "Lock the screen" })
hl.bind(mod .. " + CTRL + R",    hl.dsp.exec_cmd("killall -SIGUSR2 waybar"),
...
hl.bind(mod .. " + SHIFT + L",      hl.dsp.focus({ workspace = "e+1" }), { description = "Scroll through workspaces incrementally" })
hl.bind(mod .. " + COMMA",          hl.dsp.focus({ workspace = "e-1" }), { description = "Scroll through workspaces decrementally" })
hl.bind(mod .. " + SHIFT + H",      hl.dsp.focus({ workspace = "e-1" }), { description = "Scroll through workspaces decrementally" })
...
hl.bind(mod .. " + SLASH",          hl.dsp.workspace.toggle_special("quake"),
...
hl.bind(mod .. " + P",
    hl.dsp.exec_cmd([[hyprctl clients | grep -q "class: 1password" && hyprctl dispatch togglespecialworkspace 1password || (1password hyprctl dispatch movetoworkspacesilent special:1password,class:^1password$ && hyprctl dispatch togglespecialworkspace 1password)]]))
hl.bind(mod .. " + SPACE",
    hl.dsp.exec_cmd("1password --quick-access --toggle"))

-- ──────────────────────────────────────────────────────────────────────────
-- Push-to-talk (handy). Press triggers, release triggers again (same signal).
-- ──────────────────────────────────────────────────────────────────────────
hl.bind("ALT + SPACE", hl.dsp.exec_cmd("pkill -USR2 -n handy"),
    { description = "Start recording via handy" })
hl.bind("ALT + SPACE", hl.dsp.exec_cmd("pkill -USR2 -n handy"),
    { release = true, description = "Stop recording via handy" })

hl.bind("F2", hl.dsp.exec_cmd("pkill -USR2 -n handy"),
    { description = "Start recording via handy" })
hl.bind("F2", hl.dsp.exec_cmd("pkill -USR2 -n handy"),
    { release = true, description = "Stop recording via handy" })
